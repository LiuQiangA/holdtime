<template>
    <div class="peixun">
        <div class="bigData-head"><a href="javascript:history.go(-1)"><i class="icon iconfont icon-fanhui"></i></a>教学运营统计分析</div>
                ...
                <div class="xueshiT">
                    <div class="xueshiT-item">
                        <p class="yunyingQK-head">本月车辆
                            <span class="yunyingQK-nomal">教学次数</span>
                        </p>
                        <div class="yunyingQK-nomal-num">1570
                            <span class="yunyingQK-danwei-nomal"> 次</span>
                        </div>
                    ...
                    <div class="xueshiT-item">
                        ...
                        <div class="yunyingQK-nomal-num">91570
